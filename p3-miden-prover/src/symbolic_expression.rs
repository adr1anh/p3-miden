...
mod tests {
    ...
    fn test_symbolic_expression_degree_multiple() {
        ...
        assert_eq!(add_expr.degree_multiple(), 1);
        ...
        assert_eq!(sub_expr.degree_multiple(), 1);

        let neg_expr = SymbolicExpression::<BabyBear>::Neg {
            x: Arc::new(variable_expr.clone()),
            degree_multiple: 1,
        };
        assert_eq!(neg_expr.degree_multiple(), 1);
        ...
        assert_eq!(mul_expr.degree_multiple(), 2);
    }
    ...
    fn test_addition_of_constants() {
        ...
        let result = a + b;
        assert!(matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::new(7)));
    }
    ...
    fn test_subtraction_of_constants() {
        ...
        let b = SymbolicExpression::Constant(BabyBear::new(4));
        let result = a - b;
        assert!(matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::new(6)));
    }
    ...
    fn test_negation() {
        ...
        let result = -a;
        assert!(
            matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::NEG_ONE * BabyBear::new(7))
        );
    }
    ...
    fn test_multiplication_of_constants() {
        ...
        let result = a * b;
        assert!(matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::new(15)));
    }
    ...
    fn test_sum_operator() {
        ...
        assert!(matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::new(10)));
    }
    ...
    fn test_product_operator() {
        ...
        assert!(matches!(result, SymbolicExpression::Constant(v) if v == BabyBear::new(24)));
    }

    #[test]
    fn test_default_is_zero() {
        let expr: SymbolicExpression<BabyBear> = Default::default();
        assert!(matches!(expr, SymbolicExpression::Constant(c) if c == BabyBear::ZERO));
    }
    ...
    fn test_empty_sum_returns_zero() {
        ...
        assert!(matches!(result, SymbolicExpression::Constant(c) if c == BabyBear::ZERO));
    }
    ...
    fn test_empty_product_returns_one() {
        ...
        assert!(matches!(result, SymbolicExpression::Constant(c) if c == BabyBear::ONE));
    }
