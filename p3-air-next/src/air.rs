...
pub trait PermutationAirBuilder: ExtensionBuilder {
    ...
    /// Variable type for prover-supplied permutation values (extension field).
    type PermutationVal: Into<Self::ExprEF> + Copy;
    ...
    /// Return the list of prover-supplied permutation values.
...
impl<AB: PermutationAirBuilder> PermutationAirBuilder for FilteredAirBuilder<'_, AB> {
    ...
    type PermutationVal = AB::PermutationVal;
